...
class GuildController {
  ...
  public getGuild = async (
    ...
    try {
      ResponseWrapper(req, res, {
        data: await this.guildsService.getGuildData(req),
      });
    } catch (error) {
      next(error);
    }
  ...
  public setAutomod = async (
    req: RequestWithGuild,
    res: Response,
    next: NextFunction
  ): Promise<void> => {
    try {
      const automod = await this.guildsService.setGuildAutomod(req);
      ResponseWrapper(req, res, { data: automod });
    } catch (error) {
      next(error);
    }
  };

  public getAutomod = async (
    req: RequestWithGuild,
    res: Response,
    next: NextFunction
  ): Promise<void> => {
    try {
      const automod = await this.guildsService.getGuildAutomod(req);
      ResponseWrapper(req, res, { data: automod });
    } catch (error) {
      next(error);
    }
  ...
  public deleteAutomod = async (
    req: RequestWithGuild,
    res: Response,
    next: NextFunction
  ): Promise<void> => {
    try {
      const automods = await this.guildsService.deleteGuildAutomod(req);
      ResponseWrapper(req, res, { data: automods });
    } catch (error) {
      next(error);
    }
  };
